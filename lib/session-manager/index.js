...
var SessionManager = /** @class */ (function () {
    ...
    SessionManager.logout = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, middleware, realmPath, serverConfig, sessionCookieName, sessionCookieValue, init, path, url, runMiddleware, req, response;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        sessionCookieValue = window.localStorage.getItem(sessionCookieName) || '';
                        init = {
                            headers: new Headers((_b = {},
                                _b[sessionCookieName] = sessionCookieValue,
                                _b['x-requested-with'] = REQUESTED_WITH,
                                _b)),
                            method: 'POST',
                        };
